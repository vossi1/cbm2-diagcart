...
TestInterrupt:
	...
	lda tpi1+CR
	and #$fd
	ora #$31			; set mode=1 (interrupt), charset 2
	sta tpi1+CR
	lda tpi1+MIR
...
; messages
!ifdef VOSSI {
TitleHP256:	!scr " COMMODORE CBM 700 (256K) DIAGNOSTIC V. 1.1 05/2024 VOSSI"
TitleHP128:	!scr " COMMODORE CBM 700 (128K) DIAGNOSTIC V. 1.1 05/2024 VOSSI"
TitleLP256:	!scr " COMMODORE CBM 600 (256K) DIAGNOSTIC V. 1.1 05/2024 VOSSI"
TitleLP128:	!scr " COMMODORE CBM 600 (128K) DIAGNOSTIC V. 1.1 05/2024 VOSSI"
} else{
